...
<div class="vbox w1200">
	...
	<div class="w1200 h500 boda">
		<img src="${cpath }/boardFile/${dto.uploadFile}" height="300px">
		<pre>${dto.context }</pre>
	</div>
</div>
...
<div class="hbox sb w1200">
	<div>
		<a href="${cpath }/board/1"><button class="btn">목록</button></a>
	</div>
	<div>
		<c:if test="${login.idx == dto.writer }">
		<a href="${cpath }/update/${dto.idx}"><button class="btn">수정</button></a>
...
<script>
	...
	deleteBtn.onclick = () => {
		...
		if(select) {
			location.replace('delete/${dto.idx}');
		}
	};
</script>
